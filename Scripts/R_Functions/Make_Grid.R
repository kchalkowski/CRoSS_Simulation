...
#Initializes grid to run model
#Includes options for either homogeneous, uniform grid, or grid with land class preference probabilities
#Currently only option for lscape generation is random landscape, alternative clustering options will be available in future updates.
